  ...
  describe("GET /api/flashcards", () => {
    ...
    it("should handle invalid query parameters gracefully", async () => {
      ...
      await mockFlashcardService.getFlashcards("test-user-123", {
        page: 1,
        // Should default to 1 even if invalid string passed
        limit: 10,
        // Should default to 10 even if invalid string passed
        sort: "created_at",
        // Should default to valid field
        order: "desc"
  ...
  describe("POST /api/flashcards", () => {
    ...
    it("should validate required fields", async () => {
      const invalidFlashcard = {
        front: "",
        // Empty front should fail validation
        back: "Valid answer"
      };
      const mockFlashcardService = {
