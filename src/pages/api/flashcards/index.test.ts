...
describe('Flashcards API Integration Tests', () => {
  ...
  describe('POST /api/flashcards', () => {
    ...
    it('should validate required fields', async () => {
      ...
      await expect(mockFlashcardService.createFlashcard('test-user-123', invalidFlashcard))
        .rejects.toThrow('Validation failed: front is required');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle database connection errors', async () => {
      ...
      await expect(mockFlashcardService.getFlashcards('test-user-123', {}))
  ...
  describe('Search and Filtering', () => {
    it('should filter flashcards by search query', async () => {
      const mockResults = [
        { id: '1', front: 'React question', back: 'React answer' }
      ];
    ...
    it('should filter flashcards by tags', async () => {
      const mockResults = [
        { id: '1', front: 'Tagged question', back: 'Answer', tags: ['javascript'] }
      ];
